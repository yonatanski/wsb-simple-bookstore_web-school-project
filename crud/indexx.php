  ...
  <body>
    <main class="border-rounded container">
        <div class="container rounded mt-3 ">
            ...
            <h3 class="text-white mt-3" id="greeting"><h3>
            <input  class=" text-white mr-auto mt-3 btn btn-danger p-1" type="text" id="currentDateTime">
        ...
        <a href="index.php"><button class="btn btn-primary" type="button">Change to table View</button></a>
        <div class="d-flex row justify-content-center" >
     ...
     <?php
                            if(isset($_POST['read'])){
                               ...
                               if($result){
                                   ...
                                   <div class="card-deck mr-1 mt-3" >
                                   <div class="card bg-light text-dark"  >
      <img  src="./php/img/cardbook.png"   class=" img_card card-img-top" alt="Card image cap">
     <div class="card-body">
                                    
                                        <h5 class="card-title badge badge-info" data-id="<?php echo $row['id'];?>" ><?php echo $row['id'] ;?></h5>
                                        <i class='bi bi-book-half text-primary'>Book Name</i>
                                        <h4  class="card-text text-primary" data-id="<?php echo $row['id'];?>"><?php echo $row['book_name'] ;?> </h4>
                                        <i class='bi bi-paperclip text-info'>Published By</i>
                                        <p  class="card-text text-info" data-id="<?php echo $row['id'];?>"><?php echo $row['book_publisher'] ;?></p>
                                        <a href="#" class="btn  btn-primary" data-id="<?php echo $row['id'];?>">Price <?php echo '$'.$row['book_price'] ;?></a>
                              
                                   
                                        <td class="ml-5 "><i class='bi bi-pencil-square  text-danger btnedit'data-id="<?php echo $row['id'];?>"></i></td>
...
<div class="footer-copyright text-center py-3">© 2021 Copyright:
  <a > Developed By Yonatan and Samuel</a>
</div>
<!-- Copyright -->
